...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"f1107672-490f-4fc9-a7ed-d71330c72ecf\00", align 1
...
@__DSOCacheEntry_name.4 = internal constant [15 x i8] c"libavformat.so\00", align 1
@__DSOCacheEntry_name.5 = internal constant [13 x i8] c"libavutil.so\00", align 1
...
@__DSOCacheEntry_name.8 = internal constant [40 x i8] c"libffmpeg_mediametadataretriever_jni.so\00", align 1
@__DSOCacheEntry_name.9 = internal constant [10 x i8] c"libssl.so\00", align 1
@__DSOCacheEntry_name.10 = internal constant [14 x i8] c"libavcodec.so\00", align 1
...
@__DSOCacheEntry_name.13 = internal constant [14 x i8] c"libswscale.so\00", align 1
...
@dso_cache = local_unnamed_addr global [56 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 9
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([14 x i8], [14 x i8]* @__DSOCacheEntry_name.13, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 19
	%struct.DSOCacheEntry {
